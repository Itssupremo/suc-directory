...
function EditSucModal({ show, onClose, onSave, suc, allowedSections }) {
  ...
  return (
    <div className="modal show d-block" tabIndex="-1" style={{ position: 'fixed', top: 0, left: 0, width: '100vw', height: '100vh', overflow: 'hidden', backgroundColor: 'rgba(0,0,0,0.5)', zIndex: 2050 }}>
      <div className="modal-dialog modal-lg modal-dialog-scrollable" style={{ marginTop: '90px' }}>
        <div className="modal-content shadow border-0" style={{ borderRadius: '12px', overflow: 'hidden' }}>
          ...
          <form onSubmit={handleSubmit}>
            <div className="modal-body p-4">
              ...
              <div>
                <h6 className="text-uppercase tracking-wider font-weight-bold text-primary border-bottom pb-2 mb-3" style={{ fontSize: '0.85rem', letterSpacing: '0.5px', fontWeight: 600 }}>
                  <i className="bi bi-shield-check me-2"></i>Chair Designate
                </h6>
                <div className="row g-3">
                  <div className="col-md-4">
            ...
            <div className="modal-footer bg-light border-top">
              ...
              <button type="submit" className="btn text-white px-4 fw-semibold" style={{ background: 'var(--ched-blue)' }}>Save Changes</button>
            </div>
          </form>
        </div>
      </div>
